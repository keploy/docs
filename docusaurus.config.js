...
module.exports = {
  ...
  themeConfig: {
    ...
    <div className="footer__icons footer">
        ...
        <a href="https://www.instagram.com/keploy.io/" aria-label="Instagram"><svg class="footer__svg" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 448 436">
        <path d="M224 202.66A53.34 53.34 0 1 0 277.34 256 53.38 53.38 0 0 0 224 202.66Zm146.4-37.4a54 54 0 0 0-30.6-30.6c-21.2-8.5-71.6-6.6-95.8-6.6s-74.6-1.9-95.8 6.6a54 54 0 0 0-30.6 30.6c-8.5 21.2-6.6 71.6-6.6 95.8s-1.9 74.6 6.6 95.8a54 54 0 0 0 30.6 30.6c21.2 8.5 71.6 6.6 95.8 6.6s74.6 1.9 95.8-6.6a54 54 0 0 0 30.6-30.6c8.5-21.2 6.6-71.6 6.6-95.8s1.9-74.6-6.6-95.8ZM224 338a82 82 0 1 1 82-82 82 82 0 0 1-82 82Zm85.2-148.6a19.2 19.2 0 1 1 19.2-19.2 19.22 19.22 0 0 1-19.2 19.2Z"/>
        </svg></a>
        </div>
     <div className="footer__icons footer">
