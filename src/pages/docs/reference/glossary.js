...
function Glossary() {
    ...
    const entries = {
        ...
        'F': [
            {name:'Functional Testing',link: '/docs/concepts/reference/glossary/functional-testing'},
        ],
        'I': [
            { name: 'Integration Testing', link: '/docs/concepts/reference/glossary/integration-testing' },
            { name: 'Idempotency', link:'/docs/concepts/reference/glossary/idempotency'}
        ],
        'M': [
            { name: 'Manual Testing', link: '/docs/concepts/reference/glossary/manual-testing' },
            { name: 'Mocks',link:'/docs/concepts/reference/glossary/mocks'},
        ],
        'R': [
            { name: 'Regression Testing', link: '/docs/concepts/reference/glossary/regression-testing' },
        ],
        'S': [
        ...
        >
            <main className="margin-vert--lg container flex flex-col justify-evenly">
                ...
                <div className="flex flex-row justify-evenly">
                    ...
                    key={i} disabled={entries[String.fromCharCode(65 + i)] === undefined ? true : false}
