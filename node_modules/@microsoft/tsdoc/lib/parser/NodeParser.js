...
import { DocBlockTag, DocCodeSpan, DocErrorText, DocEscapedText, DocHtmlAttribute, DocHtmlEndTag, DocHtmlStartTag, DocInlineTag, DocPlainText, DocSoftBreak, EscapeStyle, DocBlock, DocParamBlock, DocFencedCode, DocLinkTag, DocMemberReference, DocDeclarationReference, DocMemberSymbol, DocMemberIdentifier, DocMemberSelector, DocInheritDocTag } from '../nodes';
...
var NodeParser = /** @class */ (function () {
    ...
    NodeParser.prototype._parseParamBlock = function (tokenReader, docBlockTag, tagName) {
        ...
        if (unsupportedJsdocOptionalNameOpenBracketExcerpt) {
            ...
            this._parserContext.log.addMessageForTokenSequence("tsdoc-param-tag-with-invalid-optional-name" /* ParamTagWithInvalidOptionalName */, 'The ' +
                tagName +
