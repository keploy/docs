...
description: "Platform-specific requirements for Keploy on macOS, Windows, and Linux — native support on each, when to use Docker, Lima or WSL, and kernel version prerequisites."
tags:
  - linux
  - ebpf
  - installation
